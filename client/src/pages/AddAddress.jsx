            ...
            <div className="flex-1 bg-white p-6 rounded-lg shadow">
                ...
                <form onSubmit={submitHandler}
                    ...
                    <div >
                        ...
                        <input type="number" name='zipCode' value={address.zipCode}
                            onChange={handleChange} className='w-full p-2 border rounded-md' required />
                    </div>
                    <div >
                    ...
                    <div className="col-span-2">
                        <button type='submit' className="w-full bg-indigo-500 p-2 hover:bg-indigo-600 text-white rounded-md">
                            Save Address
                        </button>
                    </div>
                </form>
            </div>
            {/* Right Side Of address Saving */}
            <div className="flex-1 flex items-center justity-center">
                <img src={assets.add_address_iamge} alt="Address illustration" className='w-full max-w-x5 rounded-lg shadow-md' />
            </div>
        </div>
    )
}
